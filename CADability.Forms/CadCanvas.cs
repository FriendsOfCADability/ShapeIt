...
namespace CADability.Forms
{
    ...
    public class CadCanvas : Control, ICanvas
    {
        ...
        Rectangle ICanvas.ClientRectangle => Subst(base.ClientRectangle);
        ...
        void ICanvas.ShowView(IView toShow)
        {
            ...
            {
                // no GDI painting, would need to adapt PaintToGDI to CADability.Substitute types
                //case "GDI":
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            else e.Graphics.FillRectangle(new System.Drawing.SolidBrush(System.Drawing.Color.BlanchedAlmond), e.ClipRectangle);
        ...
        protected override void OnSizeChanged(System.EventArgs e)
        {
            ...
            {
                lastClientRect = Subst(this.ClientRectangle);
            }
        }
