...
using static CADability.BooleanOperation;
...
namespace ShapeIt
{
    internal class SelectSecondSolidAction : ConstructAction
    {
        ...
        private BooleanOperation.Operation operation;
        ...
        public SelectSecondSolidAction(Solid firstSolid, BooleanOperation.Operation operation)
        {
        ...
        public override void OnDone()
        {
            ...
            if (secondSolid != null)
            {
                ...
                {
                    case Operation.union:
                        Solid res = NewBooleanOperation.Unite(firstSolid, secondSolid);
                        if (res != null)
                        {
                        ...
                        break;
                    case Operation.intersection:
                        Solid[] intersections = NewBooleanOperation.Intersect(firstSolid, secondSolid);
                        ...
                        break;
                    case Operation.difference:
                        Solid[] difference = NewBooleanOperation.Subtract(firstSolid, secondSolid);
                    ...
                    case Operation.clip: // misused for splitting here
                        ...
                        Solid[] res1 = NewBooleanOperation.Subtract(firstSolid, secondSolid);
                        Solid[] res2 = NewBooleanOperation.Subtract(secondSolid, firstSolid);
                        Solid[] res3 = NewBooleanOperation.Intersect(firstSolid, secondSolid);
